...
class Waitlist:
    def __init__(self,name,role,email_address,hospital_name,specialty, number_of_practitioners: NumberOfPractitioners,challenge:None, _id=None, created_at=None):
